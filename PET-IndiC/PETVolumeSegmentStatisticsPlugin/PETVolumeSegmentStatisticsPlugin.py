...
class PETVolumeSegmentStatisticsPlugin(SegmentStatisticsPluginBase):
  ...
  def getMeasurementInfo(self, key):
    ...
    info["std"] = \
      self.createMeasurementInfo(name="Standard deviation", description="Standard deviation of uptake values",
                                   units=scalarVolumeUnits.GetCodeMeaning(),
                                   quantityDicomCode=scalarVolumeQuantity.GetAsString(),
                                   unitsDicomCode=scalarVolumeUnits.GetAsString(),
    ...
    info["min"] = \
      self.createMeasurementInfo(name="Minimum", description="Minimum uptake value",
                                   units=scalarVolumeUnits.GetCodeMeaning(),
                                   quantityDicomCode=scalarVolumeQuantity.GetAsString(),
                                   unitsDicomCode=scalarVolumeUnits.GetAsString(),
    ...
    info["max"] = \
      self.createMeasurementInfo(name="Maximum", description="Maximum uptake value",
                                   units=scalarVolumeUnits.GetCodeMeaning(),
                                   quantityDicomCode=scalarVolumeQuantity.GetAsString(),
                                   unitsDicomCode=scalarVolumeUnits.GetAsString(),
    ...
    info["rms"] = \
      self.createMeasurementInfo(name="RMS", description="Root mean square uptake value",
                                   units=scalarVolumeUnits.GetCodeMeaning(),
                                   quantityDicomCode=scalarVolumeQuantity.GetAsString(),
                                   unitsDicomCode=scalarVolumeUnits.GetAsString(),
    ...
    info["volume"] = \
      self.createMeasurementInfo(name="Volume", description="Sum of segmented voxel volumes", units="ml",
                                   ...
                                   measurementMethodDicomCode=self.createCodedEntry('126030','DCM','Sum of segmented voxel volumes'))
                                                          
    info["1st_quartile"] = \
      self.createMeasurementInfo(name="1st quartile", description="1st quartile uptake value",
                                   units=scalarVolumeUnits.GetCodeMeaning(),
                                   quantityDicomCode=scalarVolumeQuantity.GetAsString(),
                                   unitsDicomCode=scalarVolumeUnits.GetAsString(),
    ...
    info["median"] = \
      self.createMeasurementInfo(name="Median", description="Median uptake value",
                                   units=scalarVolumeUnits.GetCodeMeaning(),
                                   quantityDicomCode=scalarVolumeQuantity.GetAsString(),
                                   unitsDicomCode=scalarVolumeUnits.GetAsString(),
    ...
    info["3rd_quartile"] = \
      self.createMeasurementInfo(name="3rd quartile", description="3rd quartile uptake value",
                                   units=scalarVolumeUnits.GetCodeMeaning(),
                                   quantityDicomCode=scalarVolumeQuantity.GetAsString(),
                                   unitsDicomCode=scalarVolumeUnits.GetAsString(),
    ...
    info["upper_adjacent"] = \
      self.createMeasurementInfo(name="Upper_adjacent", description="Upper adjacent", units="%",
    ...
    info["TLG"] = \
      self.createMeasurementInfo(name="TLG", description="Total lesion glycolysis", units="g",
    ...
    info["glycosis_Q1"] = \
      self.createMeasurementInfo(name="Glycolysis Q1", description="Glycolysis within first quarter of intensity range", units="g",
                                   quantityDicomCode=self.createCodedEntry("250145","99PMP","Glycolysis Within First Quarter of Intensity Range", True),
                                   unitsDicomCode=self.createCodedEntry("g","UCUM","Gram", True))
                                   
    info["glycosis_Q2"] = \
      self.createMeasurementInfo(name="Glycolysis Q2", description="Glycolysis within second quarter of intensity range", units="g",
                                   quantityDicomCode=self.createCodedEntry("250146","99PMP","Glycolysis Within Second Quarter of Intensity Range", True),
                                   unitsDicomCode=self.createCodedEntry("g","UCUM","Gram", True))
                                   
    info["glycosis_Q3"] = \
      self.createMeasurementInfo(name="Glycolysis Q3", description="Glycolysis within third quarter of intensity range", units="g",
                                   quantityDicomCode=self.createCodedEntry("250147","99PMP","Glycolysis Within Third Quarter of Intensity Range", True),
                                   unitsDicomCode=self.createCodedEntry("g","UCUM","Gram", True))
                                   
    info["glycosis_Q4"] = \
      self.createMeasurementInfo(name="Glycolysis Q4", description="Glycolysis within fourth quarter of intensity range", units="g",
    ...
    info["Q1_distribution"] = \
      self.createMeasurementInfo(name="Q1 distribution", description="Percent within first quarter of intensity range", units="%",
    ...
    info["Q2_distribution"] = \
      self.createMeasurementInfo(name="Q2 distribution", description="Percent within second quarter of intensity range", units="%",
    ...
    info["Q3_distribution"] = \
      self.createMeasurementInfo(name="Q3 distribution", description="Percent within third quarter of intensity range", units="%",
    ...
    info["Q4_distribution"] = \
      self.createMeasurementInfo(name="Q4 distribution", description="Percent within fourth quarter of intensity range", units="%",
                                   quantityDicomCode=self.createCodedEntry("250143","99PMP","Percent Within Fourth Quarter of Intensity Range", True),
                                   unitsDicomCode=self.createCodedEntry("%","UCUM","Percent", True))
                                   
    info["SAM"] = \
      self.createMeasurementInfo(name="SAM", description="Standardized added metabolic activity", units='g',
                                   quantityDicomCode=self.createCodedEntry("126037","DCM","Standardized Added Metabolic Activity", True),
                                   unitsDicomCode=self.createCodedEntry("g","UCUM","Gram", True))
                                   
    info["SAM_BG"] = \
      self.createMeasurementInfo(name="SAM background", description="Standardized added metabolic activity background",
                                   units=scalarVolumeUnits.GetCodeMeaning(),
                                   quantityDicomCode=self.createCodedEntry("126038","DCM","Standardized Added Metabolic Activity Background", True),
                                   unitsDicomCode=scalarVolumeUnits.GetAsString())
                                   
    info["peak"] = \
      self.createMeasurementInfo(name="Peak", description="Peak value within ROI",
                                   units=scalarVolumeUnits.GetCodeMeaning(),
                                   quantityDicomCode=scalarVolumeQuantity.GetAsString(),
                                   unitsDicomCode=scalarVolumeUnits.GetAsString(),
